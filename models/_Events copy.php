...
class Events extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['fname', 'lname', 'fullname', 'person_type', 'address', 'phone', 'event_date', 'event_location_note', 'las', 'long', 'work_img', 'docs', 'result', 'note', 'backup_to', 'backup_type', 'reporter', 'worker'], 'required'],
