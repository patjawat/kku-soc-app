...
class DefaultController extends Controller
{
    ...
    public function actionWord()
    {
        ...
        $templateProcessor->setValue('src1', '@web/images/cctv.png');
        $templateProcessor->setImg('img1', ['src' => '@web/img/avatar.png', 'swh' => 150]);//ที่อยู่รูป frontend/web/img/logo.png, swh ความกว้าง/สูง 150 
